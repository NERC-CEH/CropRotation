...
CM_all$pred19LC4_nonGr=factor(prd19,levels=levels(CM_all$Obs19))
...
##convert the observed and predicted classes to factors with the same set of levels
CM_all$pred19All4_nonGr=factor(prd19,levels=levels(CM_all$Obs19))
...
##convert the observed and predicted classes to factors with the same set of levels
CM_all$pred1910k4_nonGr=factor(prd19,levels=levels(CM_all$Obs19))
